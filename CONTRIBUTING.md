...
|-------|---------|
| `ad103` | `dd103` |
| `AD103 — Nonlinear Circuits` | `DD103 — RTL on FPGAs & ASICs` |
| `The diode and the MOSFET in XSchem: regions of operation, and what the parameters mean.` | `RTL synthesis intro with Yosys` |
